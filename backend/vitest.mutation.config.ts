...
export default defineConfig({
    test: {
        ...
        include: [
            ...
            "src/media/cover-xml.test.ts",
            "src/media/cover-smooth-path.test.ts",
            "src/media/cover-text-stats.test.ts",
            "src/media/cover-text-measure.test.ts",
            "src/media/cover-flow.test.ts",
            "src/media/cover-wave.test.ts",
            "src/media/cover-letterform.test.ts",
            "src/media/cover-title-text.test.ts",
            "src/media/cover-stamp.test.ts",
            "src/media/cover-font-face.test.ts",
        ],
    },
});

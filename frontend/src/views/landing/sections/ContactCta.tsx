    ...
    return (
        ...
        >
            <div className="relative overflow-hidden text-center rounded-2xl bg-surface-base border border-border-subtle p-[clamp(40px,6vw,64px)]">
                <div
                    aria-hidden
                    className="absolute -bottom-25 -left-20 w-75 h-75 rounded-full opacity-25 pointer-events-none"
                    style={{
                        background: "radial-gradient(circle, var(--color-accent-solid) 0%, transparent 70%)",
                        filter: "blur(var(--blur-aurora-soft))",
                    }}
                />
                <h2 className="relative m-0 mb-4 font-extrabold text-[clamp(28px,3.5vw,40px)] leading-[1.15] text-text-primary">
                    {pick(contact.heading)}
                </h2>
                <Text variant="body" tone="muted" className="relative mb-7 max-w-[60ch] mx-auto">

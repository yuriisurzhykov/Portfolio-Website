...
- [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds (.tracking-\[0\.12em\].mb-3\.5)
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.46 (foreground color: #f771a0, background color: #f7f5f0, font size: 8.3pt (11px), font weight: bold). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+   Element has insufficient color contrast of 2.46 (foreground color: #f771a0, background color: #f7f5f0, font size: 8.3pt (11px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"font-mono font-bold text-micro uppercase tracking-[0.12em] text-accent-text mb-3.5\" style=\"color:oklch(0.72 0.17 0)\">CASE STUDY</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".tracking-\\[0\\.12em\\].mb-3\\.5",
+         ],
+       },
+     ],
+     "tags": Array [

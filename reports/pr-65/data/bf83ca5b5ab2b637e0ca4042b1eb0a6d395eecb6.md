...
- [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds (.sm\:gap-sm > .p-0\.75.gap-0\.5.bg-surface-icon > .px-2\.5.py-1\.25[href$="flowbus"]:nth-child(2), .sm\:gap-sm > .p-1.gap-0\.5.bg-surface-icon > button:nth-child(2))
...
+         "html": "<a href=\"/ru/journal/flowbus\" class=\"rounded-pill px-2.5 py-1.25 font-mono font-semibold text-xs uppercase transition-colors duration-fast text-text-muted hover:text-text-primary\">RU</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".sm\\:gap-sm > .p-0\\.75.gap-0\\.5.bg-surface-icon > .px-2\\.5.py-1\\.25[href$=\"flowbus\"]:nth-child(2)",
+         ],
+       },
+       Object {
+         "all": Array [],

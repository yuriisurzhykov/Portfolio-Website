...
- [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds (.sm\:gap-sm > .p-0\.75.gap-0\.5.bg-surface-icon > .px-xs.py-xxs[href$="testing-culture"]:nth-child(2), .sm\:gap-sm > .p-xxs.gap-0\.5.bg-surface-icon > button:nth-child(1), .text-text-muted.text-caption[href$="journal"], .text-text-faint.leading-normal.transition-all, .transition-all[target="_blank"][rel="noreferrer"]:nth-child(1), .transition-all[target="_blank"][rel="noreferrer"]:nth-child(2), .transition-all.hover\:font-semibold.duration-normal:nth-child(3))
...
+         "html": "<a href=\"/ru/journal/testing-culture\" class=\"rounded-pill px-xs py-xxs font-mono font-semibold text-micro uppercase transition-colors duration-fast text-text-muted hover:text-text-primary\">RU</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".sm\\:gap-sm > .p-0\\.75.gap-0\\.5.bg-surface-icon > .px-xs.py-xxs[href$=\"testing-culture\"]:nth-child(2)",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "none": Array [],
+         "target": Array [
+           ".text-text-faint.leading-normal.transition-all",
+         ],
+       },
+       Object {
+         "all": Array [],

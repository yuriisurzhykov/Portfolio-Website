...
+         "html": "<a href=\"/ru\" class=\"rounded-pill px-xs py-xxs font-mono font-semibold text-micro uppercase transition-colors duration-fast text-text-muted hover:text-text-primary\">RU</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".sm\\:gap-sm > .p-0\\.75.gap-0\\.5.bg-surface-icon > .px-xs.py-xxs[href=\"/ru\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 8.3pt (11px), font weight: bold). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<div class=\"min-h-screen bg-bg-app text-text-primary flex flex-col\">",
+                 "target": Array [
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 8.3pt (11px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"font-mono font-bold text-micro uppercase tracking-widest text-text-muted shrink-0\">Tech Stack</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".tracking-widest.font-bold.shrink-0",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "html": "<div class=\"text-caption font-medium leading-normal text-text-muted mb-md flex-1\">A fixture case study covering the hero-image + approach-steps-grid template variant.</div>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".mb-md.flex-1.leading-normal",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.2 (foreground color: #787573, background color: #f6f5f4, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<a class=\"group relative block p-xl pl-2xl bg-surface-base border border-border-subtle rounded-xl hover:border-border-default transition-colors duration-normal\" href=\"/journal/testing-culture\">",
+                 "target": Array [
+                   ".group",
+                 ],
+               },
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.2 (foreground color: #787573, background color: #f6f5f4, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"text-body font-regular leading-normal text-text-muted max-w-[70ch] leading-relaxed\">A fixture post covering the plain-body template variant.</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".max-w-\\[70ch\\]",
...
+             "relatedNodes": Array [
+               Object {
+                 "html": "<div class=\"text-center rounded-2xl bg-surface-base border border-border-subtle p-[clamp(40px,6vw,64px)]\">",
+                 "target": Array [
+                   ".text-center",
+                 ],
+               },
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.2 (foreground color: #787573, background color: #f6f5f4, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"text-body font-regular leading-normal text-text-muted mb-7 max-w-[60ch] mx-auto\">Available for new engagements - embedded Android, systems architecture, or a second opinion on a hard problem.</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".mb-7",
...
+         "none": Array [],
+         "target": Array [
+           ".text-text-faint.hover\\:font-semibold.leading-normal",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "none": Array [],
+         "target": Array [
+           ".hover\\:font-semibold.transition-all.text-caption:nth-child(3)",
+         ],
+       },
+     ],
+     "tags": Array [

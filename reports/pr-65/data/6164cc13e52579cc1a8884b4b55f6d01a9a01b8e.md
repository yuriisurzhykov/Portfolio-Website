...
- [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds (.sm\:gap-sm > .p-0\.75.gap-0\.5.bg-surface-icon > .px-xs.py-xxs[href$="onboarding-flow"]:nth-child(2), .sm\:gap-sm > .p-xxs.gap-0\.5.bg-surface-icon > button:nth-child(1), .text-text-muted.text-caption[href$="work"], .mb-xl > span:nth-child(1), .mb-xl > span:nth-child(2), .mb-xl > span:nth-child(3), .text-text-faint, .transition-all[target="_blank"][rel="noreferrer"]:nth-child(1), .transition-all[target="_blank"][rel="noreferrer"]:nth-child(2), .transition-all.hover\:font-semibold.duration-normal:nth-child(3))
...
+         "html": "<a href=\"/ru/work/onboarding-flow\" class=\"rounded-pill px-xs py-xxs font-mono font-semibold text-micro uppercase transition-colors duration-fast text-text-muted hover:text-text-primary\">RU</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".sm\\:gap-sm > .p-0\\.75.gap-0\\.5.bg-surface-icon > .px-xs.py-xxs[href$=\"onboarding-flow\"]:nth-child(2)",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "none": Array [],
+         "target": Array [
+           ".text-text-muted.text-caption[href$=\"work\"]",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span>Started: Mar 2024</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span>Shipped: May 2024</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<span>Role: Contributor</span>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [

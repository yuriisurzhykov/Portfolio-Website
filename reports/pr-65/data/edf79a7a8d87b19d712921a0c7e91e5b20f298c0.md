...
- [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds (.sm\:gap-sm > .p-0\.75.gap-0\.5.bg-surface-icon > .px-xs.py-xxs[href$="work"]:nth-child(2), .sm\:gap-sm > .p-xxs.gap-0\.5.bg-surface-icon > button:nth-child(1), p, a[href$="navigation-engine"] > .py-xl.sm\:grid.sm\:grid-cols-\[3\.5rem_4\.5rem_1fr_auto_auto\] > div:nth-child(3) > .font-regular.text-body.leading-normal, a[href$="onboarding-flow"] > .py-xl.sm\:grid.sm\:grid-cols-\[3\.5rem_4\.5rem_1fr_auto_auto\] > div:nth-child(3) > .font-regular.text-body.leading-normal, .border-b.block.border-border-subtle:nth-child(4) > .py-xl.sm\:grid.sm\:grid-cols-\[3\.5rem_4\.5rem_1fr_auto_auto\] > div:nth-child(3) > .font-regular.text-body.leading-normal, .transition-all.hover\:font-semibold.font-medium, .transition-all[target="_blank"][rel="noreferrer"]:nth-child(1), .transition-all[target="_blank"][rel="noreferrer"]:nth-child(2), .transition-all.hover\:font-semibold.duration-normal:nth-child(3))
...
+         "html": "<a href=\"/ru/work\" class=\"rounded-pill px-xs py-xxs font-mono font-semibold text-micro uppercase transition-colors duration-fast text-text-muted hover:text-text-primary\">RU</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".sm\\:gap-sm > .p-0\\.75.gap-0\\.5.bg-surface-icon > .px-xs.py-xxs[href$=\"work\"]:nth-child(2)",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "html": "<p class=\"text-body font-regular leading-normal text-text-muted m-xs\">Every row below is a piece of infrastructure, not a screen. Status on the right tells you where it stands.</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "p",
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<div class=\"text-body font-regular leading-normal text-text-muted leading-normal\">A fixture case study covering the hero-image + approach-steps-grid template variant.</div>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"navigation-engine\"] > .py-xl.sm\\:grid.sm\\:grid-cols-\\[3\\.5rem_4\\.5rem_1fr_auto_auto\\] > div:nth-child(3) > .font-regular.text-body.leading-normal",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<div class=\"text-body font-regular leading-normal text-text-muted leading-normal\">A fixture case study covering the no-hero-image template variant.</div>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           "a[href$=\"onboarding-flow\"] > .py-xl.sm\\:grid.sm\\:grid-cols-\\[3\\.5rem_4\\.5rem_1fr_auto_auto\\] > div:nth-child(3) > .font-regular.text-body.leading-normal",
+         ],
+       },
+       Object {
+         "all": Array [],
...
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.37 (foreground color: #787573, background color: #fafaf9, font size: 12.0pt (16px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<div class=\"text-body font-regular leading-normal text-text-muted leading-normal\">A fixture work item with no case study — exercises the hasCaseStudy: false filter.</div>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".border-b.block.border-border-subtle:nth-child(4) > .py-xl.sm\\:grid.sm\\:grid-cols-\\[3\\.5rem_4\\.5rem_1fr_auto_auto\\] > div:nth-child(3) > .font-regular.text-body.leading-normal",
+         ],
+       },
+       Object {
+         "all": Array [],
